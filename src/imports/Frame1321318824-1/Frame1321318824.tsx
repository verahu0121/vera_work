import svgPaths from "./svg-jtag4ndbwc";
...
function SectionBentoGridProjectsAiProducts() {
  return (
    <div className="relative shrink-0 w-full" data-name="Section - Bento Grid Projects: AI Products">
      <div className="content-stretch flex flex-col gap-[72px] items-start pb-[80px] pt-[72px] px-[80px] relative size-full">
        <HorizontalBorder />
        <Frame4 />
      </div>
    </div>
...
export default function Frame() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#f2f2f2] gap-[72px] items-start pt-[144px] relative size-full to-[#e6e6e6]">

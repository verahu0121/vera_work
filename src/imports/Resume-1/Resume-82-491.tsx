import svgPaths from "./svg-7hxsizrzrc";
...
function ProfileHeaderSection() {
  return (
    <div className="content-stretch flex gap-[64px] items-start min-w-[864px] relative shrink-0 w-full" data-name="Profile Header Section">
      <Background />
      <Container />
    </div>
  );
...
function AboutMe() {
  return (
    <div className="content-stretch flex flex-col gap-[72px] items-start px-[80px] py-[72px] relative shrink-0 w-[1024px]" data-name="about me">
      ...
      <div className="content-stretch flex gap-[12px] h-[426px] items-start relative shrink-0 w-full" data-name="Bento Grid">
        <SpecialtiesSection />

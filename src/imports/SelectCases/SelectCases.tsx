import svgPaths from "./svg-0yyq72mlc1";
...
export default function SelectCases() {
  return (
    <div className="bg-[#e6e6e6] content-stretch flex flex-col gap-[96px] items-start px-[80px] py-[96px] relative size-full" data-name="select cases">
      <HeaderSection />

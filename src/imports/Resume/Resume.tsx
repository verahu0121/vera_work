import svgPaths from "./svg-gx8y43sq1i";
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[72px] items-start py-[72px] relative shrink-0 w-full">
...
function MainContentCanvas() {
  return (
    <div className="content-stretch flex flex-col items-center max-w-[1200px] overflow-x-clip overflow-y-auto relative shrink-0 w-full" data-name="Main Content Canvas">
      <Frame2 />
    </div>
  );
}

import svgPaths from "./svg-589apkvrq0";
...
export default function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[72px] items-start py-[72px] relative size-full">
      ...
      <div className="content-stretch flex gap-[4px] h-[426px] items-start px-[80px] relative shrink-0 w-[1024px]" data-name="Bento Grid">
        <SpecialtiesSection />

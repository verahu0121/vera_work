import svgPaths from "./svg-ssx5wcmw51";
...
function Link() {
  return (
    <div className="content-stretch flex gap-[8px] items-center pb-[5px] relative shrink-0" data-name="Link">
      ...
      <div className="flex flex-col font-['OPPOSans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1a1c1c] text-[13px] uppercase whitespace-nowrap">
...
function SectionProjectListNebulaFinancial() {
  return (
    <div className="content-stretch flex gap-[64px] items-start pt-[32px] relative shrink-0 w-full" data-name="Section - Project List: Nebula Financial">
      <Container1 />
      <Background2 />
    </div>
  );
...
export default function SelectCases() {
  return (
    <div className="bg-[#e6e6e6] content-stretch flex flex-col gap-[108px] items-start px-[80px] py-[128px] relative size-full" data-name="select cases">
      <HeaderSection />
      <Frame />
    </div>
  );
